...
def make_predictions(num_samples, roc_curve_file_name, uncertainty_file_name):
    ...
    print('\nMRI Model')
    print_metrics(y_test, mri_predictions, conf_matrix = True, classes = class_names, filename = 'MRI_confusion_matrix_' + str(num_samples)+'_samples')

    print('\nPET Model')
    print_metrics(y_test, pet_predictions, conf_matrix = True, classes = class_names, filename = 'PET_confusion_matrix_' + str(num_samples)+'_samples')
    ...
    print('\nFinal predictions')
    print_metrics(y_test, final_predictions, conf_matrix = True, classes = class_names, filename = 'final_confusion_matrix_'+str(num_samples)+'_samples')
    print('')
...
make_predictions(1, 'roc_auc_1_sample.jpg', 'uncertainty_1_sample.jpg')
make_predictions(50, 'roc_auc_50_samples.jpg', 'uncertainty_50_samples.jpg')
make_predictions(500, 'roc_auc_500_samples.jpg', 'uncertainty_500_samples.jpg')
make_predictions(1000, 'roc_auc_1000_samples.jpg', 'uncertainty_1000_samples.jpg')
